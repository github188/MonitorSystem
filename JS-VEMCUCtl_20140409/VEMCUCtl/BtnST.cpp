...
#define BS_TYPEMASK1 SS_TYPEMASK
...
void CButtonST::PreSubclassWindow() 
{
	...
	ModifyStyle(BS_TYPEMASK1, BS_OWNERDRAW, SWP_FRAMECHANGED);
...
LRESULT CButtonST::OnSetStyle(WPARAM wParam, LPARAM lParam)
{
	...
	return DefWindowProc(BM_SETSTYLE,
		(wParam & ~BS_TYPEMASK1) | BS_OWNERDRAW, lParam);
} // End of OnSetStyle
...
DWORD CButtonST::SetURL(LPCTSTR lpszURL)
{
	...
	if (lpszURL)
	{
		...
		//±»É¾µôÁË
		 //strcpy_s(m_szURL, lpszURL, _MAX_PATH);
	} // if
