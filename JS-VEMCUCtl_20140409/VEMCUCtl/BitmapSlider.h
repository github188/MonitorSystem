...
#define WM_BITMAPSLIDER_LBUTTONDOWN (WM_USER +9427)
...
public:
	...
	BOOL SetDrawLinePoint(int nPos);
	BOOL SetDrawLinePointFlag(bool bFlag);
...
protected:
	...
	BOOL ModifyBitmapSizeBySlider(CBitmap &Bmp,UINT nBitmapID);

	BOOL DrawLineAroundPoint(CMemDCN &dc);
	...
	bool m_bDrawLineFlag;//画线标志
	int  m_nLinePoint;//画线点
	CPen m_LinePen1;
	CPen m_LinePen2;
