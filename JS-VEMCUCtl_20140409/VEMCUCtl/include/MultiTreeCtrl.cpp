...
CMultiTreeCtrl::CMultiTreeCtrl()
{
	...
	m_nHoverTimerID = 0;
	m_nScrollTimerID = 0;
	m_hDragLeft    = AfxGetApp()->LoadCursor(IDB_BITMAP_YT_LEFT  );
	m_hDragRight   = AfxGetApp()->LoadCursor(IDB_BITMAP_YT_RIGHT );
	m_hDragAbove   = AfxGetApp()->LoadCursor(IDB_BITMAP_YT_UP );
	m_hDragBelow   = AfxGetApp()->LoadCursor(IDB_BITMAP_YT_DOWN );
	m_hDragAppend  = AfxGetApp()->LoadCursor(IDB_BITMAP_YT_ZOOMIN);
 	m_hDragCancel  = AfxGetApp()->LoadCursor(IDB_BITMAP_YT_ZOOMOUT);
}
