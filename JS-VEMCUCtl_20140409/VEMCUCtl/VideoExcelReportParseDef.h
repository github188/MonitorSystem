...
typedef struct _video_excel_report_callback_data_ 
{
	...
	char	strCmdRsp[VIDOE_EXCEL_REPORT_MAX_MSG_LEN];		//响应命令
	char	strInBuf[VIDOE_EXCEL_REPORT_MAX_DATA_LEN];		    //原始报文
	char	strOutBuf[VIDOE_EXCEL_REPORT_MAX_DATA_LEN];	    //server发生的响应报文
