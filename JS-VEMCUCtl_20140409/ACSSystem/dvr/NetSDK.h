...
#define DL_SET_PRESET						1	// 设置预置点 
#define DL_CLE_PRESET						2	// 清除预置点 
#define DL_GOTO_PRESET						3	// 转到预置点

#define DL_LIGHT_PWRON						3	// 接通灯光电源 //2010-10-28   2------->3
#define DL_WIPER_PWRON						2	// 接通雨刷开关 //2010-10-28   3------->2
#define DL_FAN_PWRON						4	// 接通风扇开关 
#define DL_HEATER_PWRON					5	// 接通加热器开关 
#define DL_AUX_PWRON						6	// 接通辅助设备开关 

#define PTZ_STOP						10	//停止云台动作

#define DL_ZOOM_IN							11	// 焦距以速度SS变大(倍率变大) 
#define DL_ZOOM_OUT						12	// 焦距以速度SS变小(倍率变小) 
#define DL_FOCUS_NEAR						13	// 焦点以速度SS前调 
#define DL_FOCUS_FAR						14	// 焦点以速度SS后调 
#define DL_IRIS_OPEN						15	// 光圈以速度SS扩大 
#define DL_IRIS_CLOSE						16	// 光圈以速度SS缩小 
#define DL_TILT_UP							21	// 云台以SS的速度上仰 
#define DL_TILT_DOWN						22	// 云台以SS的速度下俯 
#define DL_PAN_LEFT						23	// 云台以SS的速度左转 
#define DL_PAN_RIGHT						24	// 云台以SS的速度右转 
#define DL_PAN_AUTO						29	// 云台以SS的速度左右自动扫描 
...
{
	DWORD dwSize;
	BYTE sDVRName[DL_NAME_LEN];		//DVR名称
...
typedef struct
{
	...
	BYTE sPPPoEUser[DL_NAME_LEN];							//PPPoE用户名
...
typedef struct
{
	...
	BYTE sUsername[DL_NAME_LEN];		// 用户名 
...
{
	DWORD dwSize;
	BYTE sAlarmInName[DL_NAME_LEN];	// 名称 
...
{
	DWORD dwSize;
	BYTE sAlarmOutName[DL_NAME_LEN];	// 名称 
...
typedef struct 
{
	...
	union
	{
		...
		{
			DWORD dwChannel;
			BYTE sUserName[DL_NAME_LEN];	//请求视频用户名
			BYTE sPassword[PASSWD_LEN];	// 密码 
