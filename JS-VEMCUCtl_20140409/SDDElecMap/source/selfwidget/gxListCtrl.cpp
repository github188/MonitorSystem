...
#include "selfwidget/gxEditCell.h"
...
CEdit* gxListCtrl::EditSubItem (int Item, int Column)
{
	//CHENZHONG
    SetItemState( Item, LVIS_SELECTED | LVIS_FOCUSED , 
                                LVIS_SELECTED | LVIS_FOCUSED);
	if ((Column!=2)&&(Column!=1)) return NULL;	
	...
	if (Column==1) pEdit->LimitText(16);
	if (Column==2) pEdit->LimitText(8);
